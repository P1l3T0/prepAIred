...
namespace prepAIred.Services
{
    ...
    public interface IAIService
    {
        ...
        Task<List<Interview>> AskAiAgentAsync<TInterview>(AIAgent agent, string prompt) where TInterview : Interview;

        /// <summary>
        /// Evaluates interview responses using the specified AI agent and returns updated interview objects with evaluation results.
        /// </summary>
